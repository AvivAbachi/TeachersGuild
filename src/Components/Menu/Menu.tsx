...
@inject('GlobalStore')
@observer
export default class MenuView extends Component<iProps, iState> {
  ...
  render() {
    return !this.props.isMobile ? <MenuDesktopView scroll={this.state.scroll} /> : <MenuMobileView scroll={this.state.scroll} />;
  }
}
