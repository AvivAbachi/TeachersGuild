                ...
                <nav
                    ...
                    <div className={styles.menu}>
                        <p className={isClass} onClick={e => this.toggleProgramSub()}>
                            Programs<i className={this.state.menuIcon}/>
                        </p>
                        <a
                            className={isClass}
                            href={GlobalData.noLink}
                            onClick={e => this.toggleProgramSub(false)}>Approach
                        </a>
                        <a
                            className={isClass}
                            href={GlobalData.noLink}
                            onClick={e => this.toggleProgramSub(false)}>Solutions
                        </a>
                        ...
                        <a
                            className={isClass}
                            href={GlobalData.noLink}
                            onClick={e => this.toggleProgramSub(false)}>Work With Us</a>
