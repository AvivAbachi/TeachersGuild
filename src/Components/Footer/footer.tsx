      ...
      <footer>
        <Row className={styles.row}>
          <Col md='5' xs={'12'} className={styles.about}>
            ...
            <p>A non-profit initiative of PLUSSED at Riverdale Country School and IDEO's Design for Learning Studio.</p>
          </Col>
          ...
          <Col md='12' xs={'12'}>
            ...
            <div className={styles.support}>
              <a href={GlobalData.noLink}>
                <img src={riverdale} alt='' width='101' />
              </a>
              <a href={GlobalData.noLink}>
                <img src={IDEO} alt='' width='101' />
              </a>
            </div>
          </Col>
        </Row>
